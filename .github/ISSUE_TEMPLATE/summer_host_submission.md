---
name: "💀 Summer Host Submission"
about: "Submit a new host for the Hall of Shame or update existing evidence."
title: "[SUBMISSION]: <Host Name>"
labels: ["host-submission", "needs-review"]
assignees: []
...
- [ ] Exit Scam / Sudden Disappearance
- [ ] "Unlimited" Resource Claims
- [ ] Illegal Operation (No registered business)

### 📂 Evidence (Required)
*You MUST provide at least one Wayback Machine (Archive.org) link as proof. Live links are discouraged as they can be changed or deleted.*

**ToS/Legal Evidence:**
> URL Here

**Technical/Panel Evidence:**
> URL Here
